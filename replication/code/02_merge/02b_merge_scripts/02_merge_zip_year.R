#############################################################################################
# Plastic Bag Ban
# Zip code, year level final data combination 
...
data <- left_join(cleanupZipYear, merged %>% dplyr::select(zip, state, medianIncome, incQuartile, incQuintile, firstEffect, completeBagBan, partialBagBan, bagLimit, plasticBagCharge, paperBagCharge, paperBagBan, repealed, repealedDate, 
...
save(data, file="data/processed/02_data_merged/02_merged_zip_year.rda")
save(dataBalanced, file="data/processed/02_data_merged/02_merged_zip_year_balanced.rda")
