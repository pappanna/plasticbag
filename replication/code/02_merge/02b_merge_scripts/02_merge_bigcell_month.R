#############################################################################################
# Plastic Bag Ban
# Big cell-level code, month level final data combination 
...
data <- left_join(cleanupBigCellMonth, merged %>% dplyr::select(zip, state, medianIncome, incQuartile, incQuintile, firstEffect, completeBagBan, partialBagBan, bagLimit, plasticBagCharge, paperBagCharge, paperBagBan, repealed, repealedDate, 
...
save(data, file="data/processed/02_data_merged/02_merged_bigcell_month.rda")
