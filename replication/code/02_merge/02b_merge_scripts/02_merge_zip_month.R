...
load('data/processed/00_data_intermediate/00_data_zip_month.rda')
...
data <- left_join(cleanupZipMonth, merged %>% dplyr::select(zip, state, medianIncome, incQuartile, incQuintile, firstEffect, completeBagBan, partialBagBan, bagLimit, plasticBagCharge, paperBagCharge, paperBagBan, repealed, repealedDate, 
...
save(data, file="data/processed/02_data_merged/02_merged_zip_month.rda")
