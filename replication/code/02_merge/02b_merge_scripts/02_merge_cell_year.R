#############################################################################################
# Plastic Bag Ban
# Cell code, year level final data combination 
...
data <- left_join(cleanupCellYear, merged %>% dplyr::select(zip, state, medianIncome, incQuartile, incQuintile, firstEffect, completeBagBan, partialBagBan, bagLimit, plasticBagCharge, paperBagCharge, paperBagBan, repealed, repealedDate, 
...
save(data, file="data/processed/02_data_merged/02_merged_cell_year.rda")
save(dataBalanced, file="data/processed/02_data_merged/02_merged_cell_year_balanced.rda")
