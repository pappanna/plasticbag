...
load('data/processed/00_data_intermediate/00_data_cell_month_other.rda')
...
data <- left_join(cleanupCellMonthOther, merged %>% dplyr::select(zip, state, medianIncome, incQuartile, incQuintile, firstEffect, completeBagBan, partialBagBan, bagLimit, plasticBagCharge, paperBagCharge, paperBagBan, repealed, repealedDate, 
...
save(data, file="data/processed/02_data_merged/02_merged_cell_month_other.rda")
