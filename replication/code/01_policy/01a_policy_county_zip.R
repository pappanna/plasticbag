...
pacman::p_load(data.table, ggplot2, dplyr, readr, tidyr, broom, stargazer, stringr, lubridate, raster, sf, ggpubr, readxl)    
...
zipPoliciesYear <- zipPolicies %>% filter(repealed != 1) %>% distinct(zip, effect, policyType, popIRS, complete_bag_ban, partial_bag_ban, plastic_bag_charge, policyType)
...
save(county, file="data/processed/01_county_policy.rda")
